...
final class FashionTaxonomyNormalizer
{
    private const CATEGORY_ALIASES = [
        'áo sơ mi' => ['shirt', 'shirts', 'tops', 'top', 'button down', 'button-down', 'dress shirt', 'sơ mi', 'áo sơ mi'],
        'áo thun' => ['t shirt', 't-shirt', 'tee', 'tees', 'áo thun', 'áo phông'],
        'áo polo' => ['polo', 'polo shirt', 'áo polo'],
        'áo len' => ['sweater', 'jumper', 'knitwear', 'áo len'],
        'áo hoodie' => ['hoodie', 'sweatshirt', 'áo hoodie'],
        'áo khoác' => ['jacket', 'jackets', 'outerwear', 'sports jacket', 'sport jacket', 'áo khoác'],
        'áo vest' => ['blazer', 'blazers', 'suit jacket', 'áo vest', 'áo blazer'],
        'quần tây' => ['trousers', 'pants', 'bottoms', 'bottom', 'tailored trousers', 'dress pants', 'formal pants', 'quần tây'],
        'quần jeans' => ['jeans', 'jean', 'denim pants', 'quần jeans', 'quần jean'],
        'quần kaki' => ['chinos', 'chino', 'khaki pants', 'quần kaki'],
        'quần short' => ['shorts', 'short', 'quần short'],
        'quần jogger' => ['joggers', 'jogger', 'sweatpants', 'quần jogger'],
        'chân váy' => ['skirt', 'skirts', 'chân váy'],
        'váy đầm' => ['dress', 'dresses', 'gown', 'váy', 'đầm', 'váy đầm'],
        'túi xách' => ['bag', 'bags', 'handbag', 'crossbody bag', 'túi xách'],
        'thắt lưng' => ['belt', 'belts', 'thắt lưng'],
        'kính mát' => ['sunglasses', 'sunglass', 'kính mát'],
        'đồng hồ' => ['watch', 'watches', 'đồng hồ'],
