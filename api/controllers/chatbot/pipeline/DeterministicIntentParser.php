...
class DeterministicIntentParser {
    private const PRODUCT_TYPES = [
        '/áo khoác bomber|ao khoac bomber|áo bomber|ao bomber|aobomber|bomber/ui' => ['áo khoác bomber', 1, 'jacket'],
        '/áo\s*sơ\s*mi|ao\s*so\s*mi|áo\s*somi|ao\s*somi|aoso\s*mi|aosomi/ui' => ['áo sơ mi', 1, 'shirt'],
        '/áo\s*khoác|ao\s*khoac|aokhoac/ui' => ['áo khoác', 1, 'jacket'],
        '/áo\s*thun|ao\s*thun|aothun/ui' => ['áo thun', 1, 't_shirt'],
        '/áo\s*phông|ao\s*phong|aophong/ui' => ['áo phông', 1, 't_shirt'],
        '/áo\s*hoodie|ao\s*hoodie|aohoodie/ui' => ['áo hoodie', 1, 'hoodie'],
        '/áo\s*polo|ao\s*polo|aopolo/ui' => ['áo polo', 1, 'polo'],
        '/áo\s*len|ao\s*len|aolen/ui' => ['áo len', 1, 'sweater'],
        '/áo\s*gile|ao\s*gile|aogile/ui' => ['áo gile', 1, 'vest'],
        '/áo\s*vest|áo\s*blazer|ao\s*vest|ao\s*blazer|aovest|aoblazer/ui' => ['áo vest', 1, 'blazer'],
        '/quần\s*jeans?|quan\s*jeans?|quanjeans?/ui' => ['quần jeans', 2, 'jeans'],
        '/quần\s*tây|quan\s*tay|quantay/ui' => ['quần tây', 2, 'trousers'],
        '/quần\s*kaki|quan\s*kaki|quankaki/ui' => ['quần kaki', 2, 'trousers'],
        '/quần\s*shorts?|quan\s*shorts?|quanshorts?/ui' => ['quần short', 2, 'shorts'],
        '/quần\s*jogger|quan\s*jogger|quanjogger/ui' => ['quần jogger', 2, 'joggers'],
        '/váy\s*maxi|vay\s*maxi|vaymaxi/ui' => ['váy maxi', 3, 'maxi_dress'],
        '/chân\s*váy|chan\s*vay|chanvay/ui' => ['chân váy', 3, 'skirt'],
        '/váy\s*đầm|vay\s*dam|vaydam|\bđầm\b|\bdam\b/ui' => ['váy đầm', 3, 'dress'],
        '/túi\s*xách|tui\s*xach|tuixach/ui' => ['túi xách', 4, 'bag'],
        '/đồng\s*hồ|dong\s*ho|dongho/ui' => ['đồng hồ', 4, 'watch'],
        '/thắt\s*lưng|that\s*lung|thatlung/ui' => ['thắt lưng', 4, 'belt'],
        '/kính\s*mát|kinh\s*mat|kinhmat/ui' => ['kính mát', 4, 'sunglasses'],
        '/dress shoes|formal shoes|oxford shoes|derby shoes|giày\s*tây|giay\s*tay|giaytay/ui' => ['giày tây', 5, 'footwear', 'dress_shoes'],
        '/sneakers?|trainers?|giày\s*sneaker|giay\s*sneaker|giày\s*thể\s*thao|giay\s*the\s*thao/ui' => ['giày sneaker', 5, 'footwear', 'sneakers'],
        '/loafers?|giày\s*lười|giay\s*luoi|giayluoi/ui' => ['giày loafer', 5, 'footwear', 'loafers'],
        '/boots?|bốt/ui' => ['bốt', 5, 'footwear', 'boots'],
        '/sandals?|dép\s*sandal|dep\s*sandal|depsandal/ui' => ['sandal', 5, 'footwear', 'sandals'],
        '/footwear|shoes?|giày\s*dép|giay\s*dep|(?<![\p{L}])giày(?![\p{L}])|(?<![a-z])giay(?![a-z])/ui' => ['giày', 5, 'footwear', 'other'],
        '/(?<![\p{L}])áo(?![\p{L}])|(?<![a-z])ao(?![a-z])/ui' => ['áo', 1, 'top'],
        '/(?<![\p{L}])quần(?![\p{L}])|(?<![a-z])quan(?![a-z])/ui' => ['quần', 2, 'bottom'],
        '/(?<![\p{L}])váy(?![\p{L}])|(?<![a-z])vay(?![a-z])/ui' => ['váy', 3, 'dress'],
        '/phụ\s*kiện|phu\s*kien|phukien/ui' => ['phụ kiện', 4, 'accessory'],
    ];
