...
require_once ROOT_DIR . '/api/services/Fashion/StylingReferenceProvider.php';
require_once ROOT_DIR . '/api/services/Fashion/StyleReference.php';
require_once ROOT_DIR . '/api/services/Fashion/StyleReferenceSet.php';
require_once ROOT_DIR . '/api/services/Fashion/StyleReferenceRawSuggestionAdapter.php';
require_once ROOT_DIR . '/api/services/Fashion/GlanceConfig.php';
require_once ROOT_DIR . '/api/services/Fashion/GlanceMcpException.php';
require_once ROOT_DIR . '/api/services/Fashion/GlanceMcpClientContract.php';
require_once ROOT_DIR . '/api/services/Fashion/GlanceMcpClient.php';
require_once ROOT_DIR . '/api/services/Fashion/GlanceAnchorResolutionException.php';
require_once ROOT_DIR . '/api/services/Fashion/GlanceAnchorReference.php';
require_once ROOT_DIR . '/api/services/Fashion/GlanceAnchorResolverContract.php';
require_once ROOT_DIR . '/api/services/Fashion/GlanceAnchorResolver.php';
require_once ROOT_DIR . '/api/services/Fashion/GlanceResponseMappingException.php';
require_once ROOT_DIR . '/api/services/Fashion/GlanceLiveResponseMapper.php';
require_once ROOT_DIR . '/api/services/Fashion/MappedStyleReference.php';
require_once ROOT_DIR . '/api/services/Fashion/PrivateCatalogStyleMapper.php';
require_once ROOT_DIR . '/api/services/Fashion/StyleReferenceCatalogRecommendationService.php';
require_once ROOT_DIR . '/api/services/Fashion/GlanceDemoStylingProvider.php';
require_once ROOT_DIR . '/api/services/Fashion/GlanceStylingProvider.php';
...
require_once ROOT_DIR . '/api/controllers/chatbot/llm/StreamingLLMProvider.php';
...
require_once ROOT_DIR . '/api/controllers/chatbot/pipeline/StreamingResponseGenerator.php';
