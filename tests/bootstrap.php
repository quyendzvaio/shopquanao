...
require_once ROOT_DIR . '/api/services/Fashion/StyliticsConfig.php';
require_once ROOT_DIR . '/api/services/Fashion/StyliticsApiException.php';
require_once ROOT_DIR . '/api/services/Fashion/StyliticsHttpClientContract.php';
require_once ROOT_DIR . '/api/services/Fashion/StyliticsHttpClient.php';
require_once ROOT_DIR . '/api/services/Fashion/StyliticsStyleReferenceMapper.php';
require_once ROOT_DIR . '/api/services/Fashion/StyliticsAnchorSkuResolverContract.php';
require_once ROOT_DIR . '/api/services/Fashion/StyliticsCatalogSkuResolver.php';
require_once ROOT_DIR . '/api/services/Fashion/StyliticsDemoStylingProvider.php';
require_once ROOT_DIR . '/api/services/Fashion/StyliticsStylingProvider.php';
...
require_once ROOT_DIR . '/api/services/Observability/LangfuseTraceOutbox.php';
require_once ROOT_DIR . '/api/services/Observability/LangfuseOtlpTracePublisher.php';
